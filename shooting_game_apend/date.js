...
let sprite = [
  ...
  new Sprite(153, 341, 37, 33), //21,爆発6
  new Sprite(191, 349, 19, 16), //22,爆発7
  new Sprite(216, 349, 19, 16), //23,爆発8
  new Sprite(241, 350, 15, 13), //24,爆発9
  ...
  new Sprite(161, 160, 30, 29), //55,ロボ6
  ...
  new Sprite(9, 298, 32, 32), //,78,自弾アイコンL
  new Sprite(14, 298, 32, 32), //,79,自弾アイコンH
  new Sprite(19, 298, 32, 32), //,80,自弾アイコンS

  new Sprite(4, 380, 18, 258), //,81,レーザー(細)
  new Sprite(32, 428, 28, 88), //,82,レーザー(中)
  new Sprite(72, 380, 32, 88), //,83,レーザー(太)
  new Sprite(111, 380, 6, 12), //,84,ホーミング弾
  new Sprite(4, 600, 18, 11), //,85,レーザー(細)
];
